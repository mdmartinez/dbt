...
CONFIG_CONTRACT = {
    ...
    "properties": {
        ...
        "post-hook": {"type": "array", "items": HOOK_CONTRACT},
        "pre-hook": {"type": "array", "items": HOOK_CONTRACT},
        "vars": {"type": "object", "additionalProperties": True},
        "quoting": {"type": "object", "additionalProperties": True},
        "column_types": {"type": "object", "additionalProperties": True},
    },
    "required": [
        "enabled",
        "materialized",
...
PARSED_NODE_CONTRACT = deep_merge(
    ...
    {
        "properties": {
            "unique_id": {"type": "string", "minLength": 1, "maxLength": 255},
...
PARSED_NODES_CONTRACT = {
    ...
    "patternProperties": {".*": PARSED_NODE_CONTRACT},
}
...
PARSED_MACRO_CONTRACT = deep_merge(
    UNPARSED_MACRO_CONTRACT,
    {
        ...
        "properties": {
            ...
            "resource_type": {"enum": [NodeType.Macro, NodeType.Operation]},
            "unique_id": {"type": "string", "minLength": 1, "maxLength": 255},
            "tags": {
                "description": (
...
PARSED_MACROS_CONTRACT = {
    ...
    "patternProperties": {".*": PARSED_MACRO_CONTRACT},
}
