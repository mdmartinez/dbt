...
REDSHIFT_CREDENTIALS_CONTRACT = {
    ...
    "properties": {
        ...
        "cluster_id": {
            "type": "string",
            "description": ("If using IAM auth, the name of the cluster"),
        },
...
CONNECTION_CONTRACT = {
    ...
    "additionalProperties": False,
    "properties": {
        "type": {"enum": ["postgres", "redshift", "snowflake", "bigquery"]},
        "name": {"type": ["null", "string"]},
        "state": {"enum": ["init", "open", "closed", "fail"]},
        "transaction_open": {"type": "boolean"},
        "handle": {"type": ["null", "object"]},
        "credentials": {
            "description": (
